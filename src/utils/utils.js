...
function digestOrchStatuses() {
  var tableData = [
    {providerId: "11", services: [
        {serviceId: "1", serviceDef: "Billing", systemId:"20", systemName:"Gatekeeper", localCloud:"Dummy7"},
        {serviceId: "2",serviceDef: "IndoorHumidity5", systemId: "10", systemName: "Authorizator", localCloud:"Dummy6"},
        ...
        {serviceId: "5", serviceDef:"IndoorHumidity26", systemId: "19", systemName: "ChargingReserv22", localCloud:"Dummy1"},
  ...
  {providerId: "1", services: [
        ...
        {serviceId: "67",serviceDef: "IndoorHumidity2", systemId: "100", systemName: "ChargingReserv7", localCloud:"Dummy2"},
